            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="emails">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{route('propertyType.add')}}" class="nav-link">Add Property Type</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('propertyType.manage')}}" class="nav-link">Manage Property Type</a>
                        </li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div class="collapse" id="amenity">
                    <ul class="nav sub-menu">
                        ...
                        <li class="nav-item">
                            <a href="{{route('amenity.manage')}}" class="nav-link">Manage Amenity</a>
                        </li>
                    </ul>
                </div>
            </li>
