...
@section('page-content')
                    ...
                    @foreach ($propertyTypes as $propertyType)
                        <li>
                            <div class="category-block-one">
                                <div class="inner-box">
                                    <div class="icon-box"><i class="{{$propertyType->property_type_icon}}"></i></div>
                                    <h5><a href="property-details.html">{{$propertyType->property_type_name}}</a></h5>
                                    <span>52</span>
                                </div>
                            </div>
                        </li>
                        ...
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><img
                                        src="{{ asset('/') }}website/assets/images/feature/feature-1.jpg"
                                        alt=""></figure>
                                ...
                                <div class="author-info clearfix">
                                    <div class="author pull-left">
                                        <figure class="author-thumb"><img
                                                src="{{ asset('/') }}website/assets/images/feature/author-1.jpg"
                                                alt=""></figure>
                                        <h6>Michael Bean</h6>
                                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-one wow fadeInUp animated" data-wow-delay="300ms"
                        ...
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><img
                                        src="{{ asset('/') }}website/assets/images/feature/feature-2.jpg"
                                        alt=""></figure>
                                <div class="batch"><i class="icon-11"></i></div>
                                <span class="category">Featured</span>
                            </div>
                            <div class="lower-content">
                                <div class="author-info clearfix">
                                    <div class="author pull-left">
                                        <figure class="author-thumb"><img
                                                src="{{ asset('/') }}website/assets/images/feature/author-2.jpg"
                                                alt=""></figure>
                                        <h6>Robert Niro</h6>
                                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-one wow fadeInUp animated" data-wow-delay="600ms"
                        ...
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><img
                                        src="{{ asset('/') }}website/assets/images/feature/feature-3.jpg"
                                        alt=""></figure>
                                <div class="batch"><i class="icon-11"></i></div>
                                <span class="category">Featured</span>
                            </div>
                            <div class="lower-content">
                                <div class="author-info clearfix">
                                    <div class="author pull-left">
                                        <figure class="author-thumb"><img
                                                src="{{ asset('/') }}website/assets/images/feature/author-3.jpg"
                                                alt=""></figure>
                                        <h6>Keira Mel</h6>
                                    </div>
    ...
    <section class="video-section centred"
        style="background-image: url({{ asset('/') }}website/assets/images/background/video-1.jpg);">
        <div class="auto-container">
                ...
                <div class="single-item">
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 deals-block">
                            <div class="image-box">
                                <figure class="image"><img
                                        src="{{ asset('/') }}website/assets/images/resource/deals-1.jpg"
                                        alt=""></figure>
                            </div>
                        </div>
                    </div>
    ...
    <section class="testimonial-section bg-color-1 centred">
        <div class="pattern-layer"
            style="background-image: url({{ asset('/') }}website/assets/images/shape/shape-1.png);"></div>
        <div class="auto-container">
            <div class="sec-title">
                <h5>Testimonials</h5>
            ...
            <div class="single-item-carousel owl-carousel owl-theme owl-dots-none nav-style-one">
                <div class="testimonial-block-one">
                    <div class="inner-box">
                        <figure class="thumb-box"><img
                                src="{{ asset('/') }}website/assets/images/resource/testimonial-1.jpg" alt="">
                        </figure>
                        <div class="text">
                ...
                <div class="testimonial-block-one">
                    <div class="inner-box">
                        <figure class="thumb-box"><img
                                src="{{ asset('/') }}website/assets/images/resource/testimonial-2.jpg" alt="">
                        </figure>
                        <div class="text">
                            <p>Our goal each day is to ensure that our residents’ needs are not only met but
                                exceeded. To make that happen we are committed to provid ing an environment in which
                ...
                <div class="items-container row clearfix">
                        ...
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img
                                        src="{{ asset('/') }}website/assets/images/resource/place-1.jpg"
                                        alt=""></figure>
                                <div class="text">
                    ...
                    <div
                        ...
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img
                                        src="{{ asset('/') }}website/assets/images/resource/place-2.jpg"
                                        alt=""></figure>
                                <div class="text">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all illustration marketing logo">
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img
                                        src="{{ asset('/') }}website/assets/images/resource/place-3.jpg"
                                        alt=""></figure>
                                <div class="text">
                    ...
                    <div class="col-lg-8 col-md-6 col-sm-12 masonry-item small-column all brand marketing print software">
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img
                                        src="{{ asset('/') }}website/assets/images/resource/place-4.jpg"
                                        alt=""></figure>
                                <div class="text">
        ...
        <div class="auto-container">
            ...
            <div class="single-item-carousel owl-carousel owl-theme owl-dots-none nav-style-one">
                <div class="team-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img src="{{ asset('/') }}website/assets/images/team/team-1.jpg"
                                alt="">
                        </figure>
                        <div class="lower-content">
                            <div class="inner">
                ...
                <div class="team-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img src="{{ asset('/') }}website/assets/images/team/team-2.jpg"
                                alt="">
                        </figure>
                        <div class="lower-content">
                            <div class="inner">
                ...
                <div class="team-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img src="{{ asset('/') }}website/assets/images/team/team-3.jpg"
                                alt="">
                        </figure>
                        <div class="lower-content">
                            <div class="inner">
                ...
                <div class="team-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img src="{{ asset('/') }}website/assets/images/team/team-4.jpg"
                                alt="">
                        </figure>
                        <div class="lower-content">
                            <div class="inner">
                ...
                <div class="team-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img src="{{ asset('/') }}website/assets/images/team/team-5.jpg"
                                alt="">
                        </figure>
                        <div class="lower-content">
                            <div class="inner">
    ...
    <section class="cta-section bg-color-2">
        <div class="pattern-layer"
            style="background-image: url({{ asset('/') }}website/assets/images/shape/shape-2.png);"></div>
        <div class="auto-container">
                        ...
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="blog-details.html"><img
                                            src="{{ asset('/') }}website/assets/images/news/news-1.jpg"
                                            alt=""></a></figure>
                                <span class="category">Featured</span>
                            </div>
                            <div class="lower-content">
                                ...
                                <ul class="post-info clearfix">
                                    <li class="author-box">
                                        <figure class="author-thumb"><img
                                                src="{{ asset('/') }}website/assets/images/news/author-1.jpg"
                                                alt=""></figure>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="blog-details.html"><img
                                            src="{{ asset('/') }}website/assets/images/news/news-2.jpg"
                                            alt=""></a></figure>
                                <span class="category">Featured</span>
                            </div>
                            <div class="lower-content">
                                ...
                                <ul class="post-info clearfix">
                                    <li class="author-box">
                                        <figure class="author-thumb"><img
                                                src="{{ asset('/') }}website/assets/images/news/author-2.jpg"
                                                alt=""></figure>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="blog-details.html"><img
                                            src="{{ asset('/') }}website/assets/images/news/news-3.jpg"
                                            alt=""></a></figure>
                                <span class="category">Featured</span>
                            </div>
                            <div class="lower-content">
                                ...
                                <ul class="post-info clearfix">
                                    <li class="author-box">
                                        <figure class="author-thumb"><img
                                                src="{{ asset('/') }}website/assets/images/news/author-3.jpg"
                                                alt=""></figure>
