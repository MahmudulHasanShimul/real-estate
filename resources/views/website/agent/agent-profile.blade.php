                ...
                <div class="col-md-10 mx-auto">
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="image-sizing">
                                        <img src="{{ !empty($profileData->photo) ? asset('/') . $profileData->photo : url('upload/agent-image/no_image.jpg') }}"
                                            alt="profile">
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="py-3">Update Agent Profile</h3>
                                    <form class="custom-form" action="{{route('agentProfile.update')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <img id="showImage"
                                                src="{{ !empty($profileData->photo) ? asset('/') . $profileData->photo : url('upload/agent-image/no_image.jpg') }}"
                                                alt="profile">
                                        </div>
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-success w-100">Update Profile</button>
                                            <a href="{{route('agent.change.password')}}" class="mt-2">Change Password</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
